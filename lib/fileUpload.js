 ...
 * nameHint should carry the part label (e.g. 'context-part-1-of-7') — it rides
 * in the filename, because MiMo numbers files per-message (文档1, 文档2…) and
 * identical names make every turn's file look like "Document 1".
 ...
 * @param {string} nameHint Base name for the file
